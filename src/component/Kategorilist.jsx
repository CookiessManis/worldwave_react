...
const kategori = [
  ...
  {
    title: "Arsitektur",
    img: "assets/kategori-icon/kat-2.png",
  ...
  },
  {
    ...
    img: "assets/kategori-icon/kat-5.png",
    desc: "Menciptakan Ruang yang Memikat dan Berfungsional",
    link: "#",
  },
  {
    title: "Fotografi",
    img: "assets/kategori-icon/kat-6.png",
    desc: "Merekam Momen-Momen Berharga dalam Kehidupan",
    link: "#",
  },
  {
    title: "Video Music",
    img: "assets/kategori-icon/kat-7.png",
    desc: "Seni Visual dan Audio",
    link: "#",
  },
  {
    title: "Keterampilan",
    img: "assets/kategori-icon/kat-8.png",
    desc: "Kerajinan Tangan yang Unik",
    link: "#",
  },
  {
    title: "Kuliner",
    img: "assets/kategori-icon/kat-9.png",
  ...
  {
    title: "Penerbitan",
    img: "assets/kategori-icon/kat-11.png",
    desc: "Karya Tulis yang Dipublikasikan",
    link: "#",
  },
  {
    title: "Film & Animasi",
    img: "assets/kategori-icon/kat-12.png",
    desc: "Menciptakan Dunia Imajinatif yang Memikat dan Menghibur",
    link: "#",
  },
  {
    title: "Periklanan",
    img: "assets/kategori-icon/kat-13.png",
