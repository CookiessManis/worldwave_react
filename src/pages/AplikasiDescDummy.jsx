    ...
    <>
      ...
      <section className="d-flex flex-column" style={{ padding: "88px" }}>
        <div className="d-flex justify-content-between align-items-center">
          <div className="position-relative d-flex">
            <button
              style={{
                left: "0px",
                top: "50%",
                boxShadow: "0px 0px 6.25px 0px rgba(0,0,0,0.25)",
          ...
          >
            ...
            >
              Proyek ini bertujuan untuk membuat database yang memuat informasi
              pengguna dan penjual dalam konteks platform e-commerce. Database
              ini akan mencakup data pengguna, seperti informasi pribadi,
              riwayat pembelian, dan preferensi, serta data penjual, termasuk
              informasi toko, inventaris produk, dan riwayat transaksi.
              Implementasi database ini akan memungkinkan platform e-commerce
              untuk mengelola informasi pengguna dan penjual dengan efisien,
              meningkatkan pengalaman pengguna, dan mendukung operasional bisnis
              yang lebih lancar.
            </p>
      ...
      >
        <Modal.Body className="d-flex flex-column p-5">
          ...
          >
            Formulir Pengajuan{" "}
            <span style={{ color: "#1f79e5" }}>Gabung Proyek</span>
          </h2>
          ...
          <Form className="d-flex flex-column gap-3">
            ...
            <Form.Group controlId="formKeterampilan">
              ...
              >
                Keterampilan<span style={{ color: "red" }}>*</span>
              </Form.Label>
              <Form.Control
                style={{ resize: "none" }}
                as="textarea"
